        ...
        <div class="swiper swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img src="carousel/im1.jpg" class="w-100 d-block" alt="c1" />
              </div>
              <div class="swiper-slide">
                <img src="carousel/im2.jpg" class="w-100 d-block" alt="c2"/>
              </div>
              <div class="swiper-slide">
      ...
      <form>
        <div class="row align-items-end">
          <div class="col-lg-3 mb-3">
            <label class="form-label" style="font-weight: 500;"><b>Fecha Ingreso:</b></label>
            <input type="date" class="form-control shadow-none">
          </div>
          <div class="col-lg-3 mb-3">
            <label class="form-label" style="font-weight: 500;"><b>Fecha Salida:</b></label>
            <input type="date" class="form-control shadow-none">
          </div>
          <div class="col-lg-3 mb-3">
          <label class="form-label" style="font-weight: 500;"><b>Adultos:</b></label>
        ...
        <select class="form-select shadow-none">
          ...
          <label class="form-label" style="font-weight: 500;"><b>Niños:</b></label>
...
<div class="container text-center">
  <div class="row">
    <div class="col-md">
        <h2 style="font-size:40px;"><b>Vive una experiencia Premier</b></h2><br><hr><br><br>
        <h3 style="font-size:20px;text-align:justify;">Somos una empresa acreditada por el Ministerio de Turismo, en la categoría de HOTEL DOS ESTRELLAS SUPERIOR y con todas las certificaciones de acuerdo a las normas vigentes, nos destacamos por la atención personalizada que ofrecemos a nuestros huéspedes, garantizando el cumplimiento de cada uno de nuestros objetivos, comprometidos con ofrecer servicios de calidad.</h3>
    </div>
    <div class="col-md">
      <br>
...
<h2 class="mt-5 pt-4 mb-4 text-center fw-bold  text-dark", id="rooms" >Habitaciones</h2>
  ...
  <div class="container">
    <div class="row">
      ...
      <h2 class="mt-5 pt-4 mb-4 text-dark text-center fw-bold h-font" id="map">Información de contacto</h2>
      <div class="container">
        <div class="row">
