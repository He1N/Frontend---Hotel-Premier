...
<?php require('./inc/INGLES_header.php'); ?>
...
<h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font text-dark" >Rooms</h2>
...
<h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font text-dark" >Valoraciones y opiniones</h2>
